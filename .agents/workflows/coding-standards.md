...
- **Commits**: NEVER execute `git commit` unless I explicitly and directly ask you to. This is a zero-exception rule. Never assume permission from any other context.
